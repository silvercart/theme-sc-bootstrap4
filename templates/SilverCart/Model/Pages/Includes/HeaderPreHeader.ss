...
<% if $CurrentRegisteredCustomer %>
    ...
    <% end_if %>
        ...
        <a class="list-inline-item" href="{$baseHref}Security/logout/" title="<%t SilverCart\Model\Pages\Page.LOGOUT 'Logout' %>"> <span class="fa fa-sign-out"></span> <%t SilverCart\Model\Pages\Page.LOGOUT 'Logout' %></a>
<% else %>
