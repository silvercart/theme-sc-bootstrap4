        ...
        <tbody>
            <% loop $CurrentPage.CurrentMembersOrders(3) %>
                <tr>
                    ...
                    <td class="detailbutton"><a class="btn btn-sm btn-primary" href="{$CurrentPage.OrderDetailLink}{$ID}" title="<%t SilverCart\Model\Pages\Page.SHOW_DETAILS 'show details' %>"  data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"></i></a></td>
                </tr>
            <% end_loop %>
        </tbody>
    </table>
