<div class="row portrait-orientation">
    <div class="col-3 col-lg-4 col-md-3 col-sm-3 col-xs-12">
    ...
    <div class="col-9 col-lg-8 col-md-9 col-sm-9 col-xs-12">
        <div class="card-header">
            <h2 class="pull-xs-left card-title">
            ...
            <span class="pull-xs-right card-subtitle text-right"> <%t SilverCart\Model\Product\Product.PRODUCTNUMBER_SHORT 'Item no.' %>: {$ProductNumberShop}</span>
        </div>
            ...
            <div class="row">
                ...
                <div class="sc-product-shortinfo col-md-6 text-right">
                    ...
                    <div class="sc-product-price-info margin-top">
                        ...
                        <% end_if %>
                        <% if $Availability %>
                            | <span class="nowrap">{$AvailabilityStatus.singular_name}: {$Availability('tag', 'tag-availability')}</span>
                        <% end_if %>
                        </small>
                    </div>
