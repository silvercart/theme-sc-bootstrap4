    ...
    <div class="col-sm-12 col-md-10 col-lg-8">
        ...
        <% end_if %>
            ...
            <div class="card-btn-bar">
                <div class="btn-group">
                <% if $address.canEdit %>
                    <a class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="<%t SilverCart\Model\Pages\AddressHolder.EDIT 'edit' %>" id="silvercart-edit-shipping-address-id" href="{$CurrentPage.Link}editAddress/{$ID}"><span class="fa fa-pencil"></span> <%t SilverCart\Model\Pages\AddressHolder.EDIT 'edit' %></a>
                <% end_if %>
