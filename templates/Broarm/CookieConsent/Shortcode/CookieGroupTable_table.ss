    ...
    <table class="table table-auto table-striped table-sm table-bordered cookie-group-table">
        ...
        <% loop $Cookies %>
            <tr class="cookie-group-table__body-row">
                <td class="cookie-group-table__body-col cookie-group-table__body-col--name font-italic">{$Title}</td>
                <td class="cookie-group-table__body-col cookie-group-table__body-col--provider font-italic">{$Provider}</td>
                <td class="cookie-group-table__body-col cookie-group-table__body-col--purpose">{$Purpose}</td>
                <td class="cookie-group-table__body-col cookie-group-table__body-col--expiry text-nowrap">{$Expiry}</td>
            </tr>
        <% end_loop %>
        </tbody>
    </table>
