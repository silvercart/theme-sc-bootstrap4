...
function productFancyBox() {
    ...
    fancyLink.fancybox({
        ...
        tpl: {
            closeBtn: '<a title="Close" class="btn btn-primary fancybox-close" href="javascript:;" style="background-image:none; "><span aria-hidden="true">&times;</span></a>',
 ...
 */
    ...
    var StickyElement = $('.aside-inner').innerHeight() < $('.main-inner').innerHeight() ? $('.aside-inner') : $('.main-inner');
 ...
 /* disabled obout use CSS flex
 var conditional = document.querySelector('.row-eq-height.row');
